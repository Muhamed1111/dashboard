...
const Sidebar = () => {
  ...
  const normalLink = 'flex items-center gap-5 pl-4 pt-4 pb-2.5 rounded-lg text-md m-2 text-gray-700 dark:text-gray-200 dark:hover:text-black hover:bg-light-gray'
  return (
