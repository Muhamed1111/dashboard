  ...
  return (
    <div className='mt-12'>
      <div className=' flex-wrap lg:flex-nowrap justify-center'>
        ...
        h-44 rounded-xl w-full lg:w-90 p-9 pt-9 m-3 
        ...
        gap-1 items-center'>
          {earningData.map((item) => (
            ...
            dark:bg-secondary-dark-bg md:w-56 p-4 pt-9 rounded-2xl'>
              ...
              }} className='text-xl opacity-0.9 rounded-full p-4 
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
        ...
        dark:bg-secondary-dark-bg  m-3 p-4 rounded-2xl md:w-780'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            ...
            <div className='border-r-1 border-color-red m-4 pr-10'>
              <div>
                <p>
                  ...
                  cursor-pointer text-white rounded-full bg-green-400 
                  ml-3 text-xs'>
                    23%
                  </span>
                </p>
